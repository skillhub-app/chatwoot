...
# Sprint v69 — regressão de roteamento do WhatsappCloudService.
...
# foi alterado; o teste blinda o comportamento que o fix de atomicidade
# passou a depender.
describe Whatsapp::Providers::WhatsappCloudService do
  ...
  describe '#send_message routing' do
    it 'áudio com content nil → send_attachment_message, NUNCA send_text_message (regressão do bug)' do
