class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'branding' => %w[INSTALLATION_NAME LOGO LOGO_DARK LOGO_THUMBNAIL BRAND_NAME BRAND_URL],
      'uazapi' => %w[UAZAPI_ENABLED UAZAPI_BASE_URL UAZAPI_ADMIN_TOKEN UAZAPI_DEFAULT_INSTANCE_LIMIT]
    }
